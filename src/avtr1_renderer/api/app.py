...
async def process_audio_v3(
    ...
    stabilization = MotionStabilizationOptions(
        ...
        rotation_spike_guard=rotation_spike_guard,
        ...
        rotation_temporal_filter=rotation_temporal_filter,
        rotation_one_euro_min_cutoff_hz=rotation_one_euro_min_cutoff_hz,
        rotation_one_euro_beta=rotation_one_euro_beta,
        rotation_one_euro_derivative_cutoff_hz=rotation_one_euro_derivative_cutoff_hz,
        rotation_temporal_max_correction_deg=rotation_temporal_max_correction_deg,
        rotation_max_acceleration_deg=rotation_max_acceleration_deg,
        rotation_max_jerk_deg=rotation_max_jerk_deg,
        expression_spike_guard=expression_spike_guard,
        ...
        expression_temporal_filter=expression_temporal_filter,
        expression_one_euro_min_cutoff_hz=expression_one_euro_min_cutoff_hz,
        expression_one_euro_beta=expression_one_euro_beta,
        expression_one_euro_derivative_cutoff_hz=expression_one_euro_derivative_cutoff_hz,
        expression_temporal_max_correction_z=expression_temporal_max_correction_z,
        expression_max_acceleration_z=expression_max_acceleration_z,
        expression_max_jerk_z=expression_max_jerk_z,
